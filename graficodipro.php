...
series.data.setAll([{
    ...
    <?php
    while($mostrar= mysqli_fetch_array($dipro)){

?>

  category: "FRENTE DE TODOS",
  value: <?php echo $mostrar['todosdipro'] ?>
}, {
  category: "CO.PE.BO. CON VOS PODEMOS",
  value: <?php echo $mostrar['copebodipro'] ?>
}, {
  category: "FRENTE AMPLIO CATAMARQUEÑO",
  value: <?php echo $mostrar['ampliodipro'] ?>
}, {
  category: "JUNTOS POR EL CAMBIO",
  value: <?php echo $mostrar['cambiodipro'] ?>
  
}, {
  category: "VOTOS EN BLANCO",
  value: <?php echo $mostrar['blancodipro'] ?>
}, {
  category: "FRENTE DE IZQUIERDA Y TRABAJADORES",
  value: <?php echo $mostrar['izquierdadipro'] ?>
}]);
...
series.appear(1000, 100);
      ...
      <div id="chartdiv2">
    <h2 style="text-align: center;">Diputados Provinciales de la Provincia</h2>
   </div>
