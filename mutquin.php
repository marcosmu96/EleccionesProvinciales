...
$sql ="SELECT COUNT(*) mesa , SUM(cargada) as cargada , SUM(electores) as electores,
  ...
  SUM(impugnado) as impugnado,
   (SUM(copebosenac) + SUM(ampliosenac) + SUM(cambiosenac) + SUM(todossenac) + SUM(izquierdasenac) + SUM(recurridosenac) + SUM(nulosenac) + SUM(impugnado) +
SUM(blancosenac)) * 100 / SUM(electores)  as total

FROM escrutinio WHERE muninombre = 'MUTQUIN'";
...
?>
    ...
    <table class="ficha">
      ...
      <tr>
        ...
        <td><?php echo $mostrar['todosint'] ?></td>
      ...
      <tr>
        ...
        <td><?php echo $mostrar['cambioint'] ?></td>
      ...
      <tr class="votos">
        ...
        <td><?php echo $mostrar['nuloint'] ?></td>
      ...
      <tr class="votos">
        ...
        <td><?php echo $mostrar['recurridoint'] ?></td>
      ...
      <tr class="votos">
        ...
        <td><?php echo $mostrar['blancoint'] ?></td>
